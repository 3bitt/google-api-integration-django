...
let detail_view_date_type = document.getElementById('datetype_from_template');


if (detail_view_date_type){
    detail_view_date_type = JSON.parse(detail_view_date_type.textContent);
    
    switch (detail_view_date_type) {
        case 'Y':
